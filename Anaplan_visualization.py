...
def get_response(user_input, prev_messages, db, schema):
    ...
    - Generate only the SQL query based on the schema with exact names of column in the table if there is a space(" ") in name of column dont add a underscore (_) in between..
